  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4 relative overflow-hidden font-sans">
      ...
      <div className="absolute inset-0 z-0 opacity-10 pointer-events-none">
        <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_2px_2px,hsl(var(--foreground))_1px,transparent_0)] bg-[size:40px_40px]" />
      </div>
      ...
      >
        ...
        <Card className="border-border shadow-2xl">
          <CardHeader className="space-y-1 flex flex-col items-center text-center pb-8 border-b border-border/50">
            <div className="w-12 h-12 bg-primary rounded-xl flex items-center justify-center mb-4 shadow-lg shadow-primary/20">
              <Layout className="text-primary-foreground w-7 h-7" />
            </div>
