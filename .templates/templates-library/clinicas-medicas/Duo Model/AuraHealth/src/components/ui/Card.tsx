...
>(({ className, animate = true, ...props }, ref) => (
  <motion.div
    ...
    className={cn(
      "rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl text-card-foreground shadow-2xl transition-all duration-300 hover:border-white/20 hover:bg-white/10",
      className
    )}
    {...props}
  />
