    ...
    <main className="min-h-screen bg-background flex flex-col lg:flex-row overflow-hidden">
      ...
      <section className="hidden lg:flex lg:w-1/2 bg-foreground relative flex-col justify-between p-24 overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          >
            Resuming <br />
            <span className="italic text-primary">Command.</span>
          </motion.h1>
          <motion.p 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ ...transition, delay: 0.4 }}
            className="text-background/60 max-w-md italic font-light"
          >
            Secure entry to your global asset portfolio. Verified telemetry and sovereign data custody await.
          </motion.p>
        </div>
        ...
        >
          <Fingerprint className="w-[600px] h-[600px] text-background" />
        </motion.div>
      </section>
      ...
      <section className="flex-1 flex flex-col justify-center p-8 md:p-24 lg:p-32 relative">
        <Link 
          href="/" 
          className="absolute top-12 left-8 md:left-24 text-[10px] font-bold uppercase tracking-[0.2em] text-muted-foreground hover:text-foreground transition-colors flex items-center gap-2 group"
        >
          <ArrowLeft className="w-3 h-3 group-hover:-translate-x-1 transition-transform" /> Back to Sanctuary
        </Link>
        ...
        <div className="max-w-md w-full mx-auto">
          <motion.div
            ...
            transition={transition}
          >
            <h2 className="text-4xl font-serif font-bold mb-2">Identify Yourself</h2>
            <p className="text-muted-foreground mb-12 italic text-sm">Enter your credentials to access the sovereign network.</p>
          </motion.div>
          ...
          >
            <div className="space-y-6">
              <div className="space-y-2">
                <label className="text-[10px] font-bold uppercase tracking-[0.2em] text-muted-foreground">Digital Identity</label>
                <Input 
                  type="email" 
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  <label className="text-[10px] font-bold uppercase tracking-[0.2em] text-muted-foreground">Access Key</label>
                  <Link href="#" className="text-[10px] font-bold uppercase tracking-[0.1em] text-primary hover:underline">Revoke / Reset</Link>
                </div>
                <Input 
                  type="password" 
                  placeholder="••••••••••••" 
            ...
            <div className="pt-8 text-center">
              <p className="text-xs text-muted-foreground italic">
                New to the architecture? <Link href="/register" className="text-primary font-bold uppercase tracking-widest hover:underline ml-1">Inquire for access</Link>
              </p>
            </div>
          </motion.form>
        </div>
