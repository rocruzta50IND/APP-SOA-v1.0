    ...
    <div className="relative min-h-screen flex items-center justify-center p-4 overflow-hidden">
      ...
      >
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-black tracking-tighter">Scale your sales today</h1>
          <p className="text-muted-foreground text-sm mt-1">Join 500+ high-performance teams using AuraCRM</p>
        </div>
          ...
          <CardContent className="grid gap-4">
            ...
            <div className="space-y-2">
              <div className="relative">
                ...
                <Input placeholder="Work email" type="email" className="pl-10" />
              </div>
            </div>
            <div className="space-y-2">
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" />
                <Input placeholder="Create Password" type="password" className="pl-10" />
              </div>
            </div>
