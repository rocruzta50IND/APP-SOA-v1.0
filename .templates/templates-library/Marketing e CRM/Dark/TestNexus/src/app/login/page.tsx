        ...
        <Card className="border-border">
          <CardHeader className="space-y-1 text-center">
            ...
            <CardDescription className="text-muted-foreground">
              Initialize session with your enterprise credentials.
            </CardDescription>
          </CardHeader>
          <CardContent className="grid gap-4 pt-4">
            ...
            <Link href="/dashboard" className="w-full">
              <Button className="w-full font-bold uppercase tracking-tight h-11">
                Authorize Session <ArrowRight className="ml-2 h-4 w-4" />
              </Button>
            </Link>
            ...
            <div className="relative my-4">
              ...
              <div className="relative flex justify-center text-[10px] uppercase font-bold tracking-[0.2em] bg-background px-2 text-muted-foreground">
                or continue with
              </div>
            </div>

            <Button variant="outline" className="w-full font-bold uppercase tracking-tight">
