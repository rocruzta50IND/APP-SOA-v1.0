...
export default function LoginPage() {
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <Link href="/" className="absolute top-8 left-8 flex items-center gap-2 text-sm text-muted-foreground hover:text-white transition-colors group">
      ...
      >
        <Card className="border-white/10 shadow-2xl backdrop-blur-2xl">
          <CardHeader className="space-y-4 pt-10 pb-8 text-center">
            <div className="mx-auto w-12 h-12 bg-primary rounded-xl shadow-[0_0_20px_rgba(79,70,229,0.4)] flex items-center justify-center">
              <div className="w-6 h-6 bg-white/20 rounded-full" />
            </div>
            <div className="space-y-2">
              <CardTitle className="text-3xl font-bold tracking-tight">Welcome back</CardTitle>
              <p className="text-muted-foreground">Log in to your NexusMarket Pro account</p>
            </div>
          </CardHeader>
