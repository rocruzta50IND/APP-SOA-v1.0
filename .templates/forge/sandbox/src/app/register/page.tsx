...
import { Zap, ArrowRight, Github, Chrome, ShieldCheck } from "lucide-react";
    ...
    <div className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-background px-6">
      ...
      >
        <div className="mb-8 flex flex-col items-center text-center">
          ...
          <p className="mt-2 text-muted-foreground">Start managing your global workforce today</p>
        </div>
        ...
        <Card className="border-white/10 bg-black/40 backdrop-blur-3xl">
          ...
          <CardContent className="grid gap-4">
            ...
            <div className="grid gap-2">
              <label className="text-sm font-medium text-white/80" htmlFor="email">Work Email</label>
            ...
            <div className="flex items-start gap-2 mt-2">
              <div className="mt-1 flex h-4 w-4 items-center justify-center rounded border border-white/20 bg-white/5">
