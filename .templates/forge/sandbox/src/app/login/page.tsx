...
export default function LoginPage() {
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4 py-12 selection:bg-primary selection:text-primary-foreground relative overflow-hidden">
      {/* Background Decor */}
      ...
      <div className="w-full max-w-[400px] space-y-8">
        <div className="flex flex-col items-center space-y-2 text-center">
          ...
          <Badge>Acesso Restrito</Badge>
          <h1 className="text-2xl font-bold tracking-tight mt-2">Bem-vindo ao PulseNova</h1>
        ...
        <Card className="border-border/60 shadow-xl">
          ...
          <CardContent className="grid gap-4">
            ...
            <div className="grid gap-2">
              ...
              <Input id="email" type="email" placeholder="nome@clinica.com" />
            </div>
            <div className="grid gap-2">
